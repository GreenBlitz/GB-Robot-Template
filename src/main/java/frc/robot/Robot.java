...
import frc.robot.subsystems.poseestimation.poseestimator.PoseEstimationSuperstructure;
...
public class Robot {
    ...
    public static final PoseEstimationSuperstructure poseEstimator = new PoseEstimationSuperstructure(swerve);
