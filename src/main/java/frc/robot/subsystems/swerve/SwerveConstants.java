...
public record SwerveConstants(
	...
	public static final double MAX_DRIVE_ACCELERATION_METERS_PER_SECOND_SQ = 20;
	public static final double MAX_DRIVE_SKID_ACCELERATION_METERS_PER_SECOND_SQ = 10;
