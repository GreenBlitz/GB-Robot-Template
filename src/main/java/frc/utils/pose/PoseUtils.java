...
public class PoseUtils {
	...
	public static HeadingData VisionDataToHeadingData(VisionData visionData) {
		return new HeadingData(visionData.getEstimatedPose().getRotation().toRotation2d(), visionData.getTimestamp());
	}
