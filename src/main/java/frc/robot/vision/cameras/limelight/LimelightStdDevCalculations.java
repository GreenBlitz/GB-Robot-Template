...
public class LimelightStdDevCalculations {
	...
	private static StandardDeviations2D averageTagDistanceDividedByVisibleTagParabola(
		...
		return new StandardDeviations2D(
				Math.max(minStandardDeviations.xStandardDeviations(), standardDeviationFactors.xStandardDeviations() * averageTagDistanceSquaredDividedByVisibleTags),
				Math.max(minStandardDeviations.yStandardDeviations(), standardDeviationFactors.yStandardDeviations() * averageTagDistanceSquaredDividedByVisibleTags),
				Math.max(
						minStandardDeviations.angleStandardDeviations(),
	...
	private static StandardDeviations2D exponentialTagDistanceDividedByVisibleTags(
		...
		return new StandardDeviations2D(
				Math.pow(Math.E, standardDeviationFactorials.xStandardDeviations() * averageTagDistance) * standardDeviationFactors.xStandardDeviations() / numberOfVisibleTags,
				Math.pow(Math.E, standardDeviationFactorials.yStandardDeviations() * averageTagDistance) * standardDeviationFactors.yStandardDeviations() / numberOfVisibleTags,
				Math.pow(Math.E, standardDeviationFactorials.angleStandardDeviations() * averageTagDistance) * standardDeviationFactors.angleStandardDeviations() / numberOfVisibleTags
		);
	}
