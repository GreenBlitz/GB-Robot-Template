...
public class Superstructure {
	...
	public Superstructure(Swerve swerve, IPoseEstimator poseEstimator, MultiAprilTagVisionSource multi) {
		this.swerve = swerve;
...
//		multi.switchLimelightsToOldBotPos();
	...
	public void periodic() {
		...
		poseEstimator.updateVision(multiVisionSources.getUnfilteredVisionData());
	}
