...
public class RealSwerveConstants {
	...
	private static final PIDConstants TRANSLATION_METERS_PID_CONSTANTS = new PIDConstants(0.85, 7.9, 0, 0.03);
	private static final PIDConstants PP_TRANSLATION_METERS_PID_CONSTANTS = new PIDConstants(1.8, 0, 0);
	private static final PIDConstants ROTATION_DEGREES_PID_CONSTANTS = new PIDConstants(0.85, 0.5, 0, 2);
	private static final PIDConstants PP_ROTATION_DEGREES_PID_CONSTANTS = new PIDConstants(2.7, 0, 0);
	...
	static SwerveConstants getSwerveConstants(String logPath) {
		return new SwerveConstants(
			...
			PP_TRANSLATION_METERS_PID_CONSTANTS,
			PP_ROTATION_DEGREES_PID_CONSTANTS
		);
	}
