 ...
 * sourcecode</a>. The limelight is using it to calculate the MegaTag2 positionRads.Rotation2d shall be used in degrees (and for rates, degrees
 * per second). Everything except the yaw is unnecessary.
 */
