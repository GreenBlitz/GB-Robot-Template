...
public class TalonFXModule implements IModule {
    ...
    public void runDriveMotorByVoltage(double voltage) {
        talonFXModuleActions.setTargetDriveOutputValue(voltage, ClosedLoopOutputType.Voltage);
    }
    ...
    public void setTargetClosedLoopVelocity(double targetVelocityMetersPerSecond) {
        ...
        talonFXModuleActions.setTargetClosedLoopVelocity(optimizedVelocityPerSecond, talonFXModuleConstants.getDriveCloseLoopOutputType());
    }
