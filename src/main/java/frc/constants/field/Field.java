...
public class Field {
	...
	public static final double BUMPER_SIZE_DX_METERS = 0.27;
	public static final double BUMPER_SIZE_DY_METERS = 0.36;
	...
	public static final Pose2d[] CORAL_STATION_SLOTS_MIDDLES = new Pose2d[] {
		new Pose2d(0.18502 + BUMPER_SIZE_DY_METERS, WIDTH_METERS - 1.1278 - BUMPER_SIZE_DX_METERS, Rotation2d.fromDegrees(126)),
		new Pose2d(0.34944 + BUMPER_SIZE_DY_METERS, WIDTH_METERS - 1.1278 + 0.11941 * 1 - BUMPER_SIZE_DX_METERS, Rotation2d.fromDegrees(126)),
		new Pose2d(0.51386 + BUMPER_SIZE_DY_METERS, WIDTH_METERS - 1.1278 + 0.11941 * 2 - BUMPER_SIZE_DX_METERS, Rotation2d.fromDegrees(126)),
		new Pose2d(0.67828 + BUMPER_SIZE_DY_METERS, WIDTH_METERS - 1.1278 + 0.11941 * 3 - BUMPER_SIZE_DX_METERS, Rotation2d.fromDegrees(126)),
		new Pose2d(0.8427 + BUMPER_SIZE_DY_METERS, WIDTH_METERS - 1.1278 + 0.11941 * 4 - BUMPER_SIZE_DX_METERS, Rotation2d.fromDegrees(126)),
		new Pose2d(1.00712 + BUMPER_SIZE_DY_METERS, WIDTH_METERS - 1.1278 + 0.11941 * 5 - BUMPER_SIZE_DX_METERS, Rotation2d.fromDegrees(126)),
		new Pose2d(1.7154 + BUMPER_SIZE_DY_METERS, WIDTH_METERS - 1.1278 + 0.11941 * 6 - BUMPER_SIZE_DX_METERS, Rotation2d.fromDegrees(126)),
		new Pose2d(1.33596 + BUMPER_SIZE_DY_METERS, WIDTH_METERS - 1.1278 + 0.11941 * 7 - BUMPER_SIZE_DX_METERS, Rotation2d.fromDegrees(126)),
		new Pose2d(1.50038 + BUMPER_SIZE_DY_METERS, WIDTH_METERS - 1.1278 + 0.11941 * 8 - BUMPER_SIZE_DX_METERS, Rotation2d.fromDegrees(126)),

		new Pose2d(0.18502 + BUMPER_SIZE_DY_METERS, 1.1278 + BUMPER_SIZE_DX_METERS, Rotation2d.fromDegrees(54)),
		new Pose2d(0.34944 + BUMPER_SIZE_DY_METERS, 1.1278 - 0.11941 * 1 + BUMPER_SIZE_DX_METERS, Rotation2d.fromDegrees(54)),
		new Pose2d(0.51386 + BUMPER_SIZE_DY_METERS, 1.1278 - 0.11941 * 2 + BUMPER_SIZE_DX_METERS, Rotation2d.fromDegrees(54)),
		new Pose2d(0.67828 + BUMPER_SIZE_DY_METERS, 1.1278 - 0.11941 * 3 + BUMPER_SIZE_DX_METERS, Rotation2d.fromDegrees(54)),
		new Pose2d(0.8427 + BUMPER_SIZE_DY_METERS, 1.1278 - 0.11941 * 4 + BUMPER_SIZE_DX_METERS, Rotation2d.fromDegrees(54)),
		new Pose2d(1.00712 + BUMPER_SIZE_DY_METERS, 1.1278 - 0.11941 * 5 + BUMPER_SIZE_DX_METERS, Rotation2d.fromDegrees(54)),
		new Pose2d(1.7154 + BUMPER_SIZE_DY_METERS, 1.1278 - 0.11941 * 6 + BUMPER_SIZE_DX_METERS, Rotation2d.fromDegrees(54)),
		new Pose2d(1.33596 + BUMPER_SIZE_DY_METERS, 1.1278 - 0.11941 * 7 + BUMPER_SIZE_DX_METERS, Rotation2d.fromDegrees(54)),
		new Pose2d(1.50038 + BUMPER_SIZE_DY_METERS, 1.1278 - 0.11941 * 8 + BUMPER_SIZE_DX_METERS, Rotation2d.fromDegrees(54)),};
