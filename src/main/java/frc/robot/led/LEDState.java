...
public enum LEDState {
	...
	START_AIM_ASSIST(new ColorFlowAnimation(200, 200, 0, 250, 1, LEDConstants.NUMBER_OF_LEDS, ColorFlowAnimation.Direction.Forward, 8)),
	IS_IN_POSITION_TO_OPEN_ELEVATOR(new StrobeAnimation(200, 200, 0)),
	SUPERSTRUCTURE_IN_POSITION(new ColorFlowAnimation(0, 200, 0, 250, 1, LEDConstants.NUMBER_OF_LEDS, ColorFlowAnimation.Direction.Forward, 8)),
