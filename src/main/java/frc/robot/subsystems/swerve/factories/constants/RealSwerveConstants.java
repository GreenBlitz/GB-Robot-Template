...
public class RealSwerveConstants {
	...
	private static final PIDConstants TRANSLATION_METERS_PID_CONSTANTS = new PIDConstants(1.9, 0.001, 0);
	private static final PIDConstants ROTATION_DEGREES_PID_CONSTANTS = new PIDConstants(2.7, 0.001, 0);
