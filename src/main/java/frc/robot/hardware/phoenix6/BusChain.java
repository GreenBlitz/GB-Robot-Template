...
public enum BusChain {
    ...
    private void createAlerts() {
        ...
        AlertManager.addAlert(
                new PeriodicAlert(Alert.AlertType.WARNING, logPath + "StatusErrorAt", () -> !busStatus.Status.isOK()));
        AlertManager.addAlert(new PeriodicAlert(
                Alert.AlertType.WARNING, logPath + "ReceiveErrorAt", () -> busStatus.REC > PERMITTED_RECEIVE_ERRORS));
        AlertManager.addAlert(new PeriodicAlert(
