...
public class LinearFilterFactory {
	...
	public static GBLinearFilter create(LinearFilterType filterType, String parentLogPath, double modifier) {
		return switch (filterType) {
			...
			case GBLinearFilter -> new LinearFilters.GBFilter((int) modifier);
		};
	}
