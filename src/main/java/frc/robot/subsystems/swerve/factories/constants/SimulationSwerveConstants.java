...
public class SimulationSwerveConstants {
	...
	private static final Rotation2d MAX_ROTATIONAL_VELOCITY_ROTATION2D_PER_SECOND = Rotation2d.fromRadians(8.178);
	...
	static SwerveConstants getSwerveConstants(String logPath) {
		return new SwerveConstants(
			...
			MAX_ROTATIONAL_VELOCITY_ROTATION2D_PER_SECOND,
