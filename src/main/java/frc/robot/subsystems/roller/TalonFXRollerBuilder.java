...
public class TalonFXRollerBuilder {
    ...
    public static Roller createTalonFXMotorRoller(String logPath, Phoenix6DeviceID rotorID,double gearRatio,int currentLimiting, Rotation2d tolerance,double KP,double KI,double KD){
        ...
        Phoenix6LatencySignal latencySignal = Phoenix6SignalBuilder.build(roller.getDevice().getPosition(),roller.getDevice().getVelocity(),RobotConstants.DEFAULT_SIGNALS_FREQUENCY_HERTZ,AngleUnit.ROTATIONS,BusChain.ROBORIO);
