...
public class StateMachineConstants {
	...
	public static final double SAFE_ZONE_DISTANCE_FROM_SCORING_POSITION_METERS = 0.3;

	public static final Translation2d SAFE_ZONE_DISTANCES_FROM_CENTER_OF_SAFE_ZONE = new Translation2d(0.3, 0.5);
