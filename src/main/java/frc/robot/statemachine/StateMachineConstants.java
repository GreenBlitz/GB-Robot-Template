...
public class StateMachineConstants {
	...
	public static final double NET_SCORING_OPEN_SUPERSTRUCTURE_X_POSITION_METERS = 0;
	public static final double SCORE_NET_X_POSITION_METERS = 0;
	public static final double MIN_NET_SCORING_Y_POSITION = 0;
