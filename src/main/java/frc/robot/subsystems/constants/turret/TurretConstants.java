...
public class TurretConstants {
	...
	public static final Rotation2d FORWARD_SOFTWARE_LIMIT = Rotation2d.fromDegrees(360);
	public static final Rotation2d BACKWARDS_SOFTWARE_LIMIT = Rotation2d.fromDegrees(0);
	public static final Rotation2d MIN_POSITION = Rotation2d.fromDegrees(10.0);
	public static final Rotation2d MAX_POSITION = Rotation2d.fromDegrees(350);
	public static final Rotation2d SCREW_POSITION = Rotation2d.fromDegrees(0);
