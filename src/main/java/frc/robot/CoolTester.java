...
//            BaseStatusSignal.refreshAll(positionSignal.getSignal(),  voltageSignal.getSignal()).isOK());
        ...
        Logger.recordOutput("Test/"+ motor.getMotor().getDeviceID() +"/VelocityMech", mechanismSimulation.getSystemVelocityRotationsPerSecond().getRotations());
        Logger.recordOutput("Test/"+ motor.getMotor().getDeviceID() +"/PositionMech", mechanismSimulation.getSystemPositionRotations().getRotations());
    }
