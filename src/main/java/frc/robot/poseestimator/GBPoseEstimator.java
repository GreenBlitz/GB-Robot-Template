...
public class GBPoseEstimator extends GBSubsystem implements IPoseEstimator {
	...
	public GBPoseEstimator(
		...
		VisionObservationLinearFilterWrapper linearFilterWrapper
	) {
		super(logPath);
		this.linearFilterWrapper = linearFilterWrapper;
...
//			Pose2d fixedPose = linearFilterWrapper.calculateFixedData(odometryPoseInterpolator);
			Pose2d fixedPose = linearFilterWrapper.calculateNonFixedData();
			...
			Pose2d currentEstimation = PoseEstimationMath
				.combineVisionToOdometry(filteredObservation, odometryPoseSample, estimatedPose, odometryPose, odometryStandardDeviations);
