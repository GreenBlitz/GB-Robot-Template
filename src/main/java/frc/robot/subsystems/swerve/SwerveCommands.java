...
public class SwerveCommands {
    ...
    public static Command getOpenLoopFieldRelativeDriveWithRotateAroundWheelCommand(
            ...
            ModuleUtils.ModuleName moduleName) {
        return new InitExecuteCommand(
                () -> SWERVE.initializeDrive(false),
                () -> SWERVE.fieldRelativeDriveRotateAroundModule(
                        xSupplier.getAsDouble(), ySupplier.getAsDouble(), thetaSupplier.getAsDouble(), moduleName),
                SWERVE);
    }
