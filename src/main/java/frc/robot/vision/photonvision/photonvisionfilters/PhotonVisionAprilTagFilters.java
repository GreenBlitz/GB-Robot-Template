...
public class PhotonVisionAprilTagFilters extends PhotonVisionFiltered {
	...
	private final VisionPoseEstimationFiltersTolerances tolerances;
	...
	public PhotonVisionAprilTagFilters(
		...
		VisionPoseEstimationFiltersTolerances tolerances
	) {
	...
	protected boolean keepPhotonVisionData(VisionRawData visionData) {
		return VisionPoseEstimationFilters.keepRobotPoseData(visionData, calculateCurrentPoseEstimation(), tolerances);
	}
	...
	public ArrayList<VisionObservation> getAllFilteredVisionObservations() {
		...
		for (VisionRawData poseData : getAllFilteredData()) {
			output.add(PoseEstimationMath.visionRawDataToObservation(poseData, calculateCurrentPoseEstimation()));
		}
		return output;
	}
