...
public class LoggedDashboardCommand extends InitExecuteCommand {
    ...
    public LoggedDashboardCommand(
            double startingValue, String widgetName, Consumer<Double> methodToRun, GBSubsystem... subsystems) {
        this(new LoggedDashboardNumber(widgetName, startingValue), methodToRun, subsystems);
    }

    public LoggedDashboardCommand(
            LoggedDashboardNumber logDashboardNumber, Consumer<Double> methodToRun, GBSubsystem... subsystems) {
