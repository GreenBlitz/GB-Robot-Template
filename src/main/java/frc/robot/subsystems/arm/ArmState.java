...
public enum ArmState {
	...
	PRE_L4(Rotation2d.fromDegrees(55), Rotation2d.fromRotations(2), Rotation2d.fromRotations(1)),
	L4(Rotation2d.fromDegrees(-25), Rotation2d.fromRotations(2), Rotation2d.fromRotations(1)),
