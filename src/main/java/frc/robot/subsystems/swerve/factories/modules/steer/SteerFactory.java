...
public class SteerFactory {
	...
	public static ControllableMotor createSteer(String logPath, ModuleUtil.ModulePosition modulePosition) {
		...
		return switch (modulePosition) {
			...
			case BACK_LEFT ->
				KrakenX60SteerBuilder.buildSteer(logPath, IDs.TalonFXIDs.SWERVE_BACK_LEFT_STEER, IDs.CANCoderIDs.SWERVE_BACK_LEFT, true,modulePosition);
			case BACK_RIGHT ->
				KrakenX60SteerBuilder.buildSteer(logPath, IDs.TalonFXIDs.SWERVE_BACK_RIGHT_STEER, IDs.CANCoderIDs.SWERVE_BACK_RIGHT, true,modulePosition);
		};
	}
