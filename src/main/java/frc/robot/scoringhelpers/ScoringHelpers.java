...
public class ScoringHelpers {
	...
	public static boolean isAfterOpeningDistance(
		Pose2d robotPose,
		Branch targetBranch,
		double scoreDistanceFromBranch,
		double openDistanceFromBranch
	) {
		return getRobotBranchScoringPose(targetBranch, scoreDistanceFromBranch).getTranslation().getDistance(robotPose.getTranslation())
			< openDistanceFromBranch;
	}
