...
public class JoysticksBindings {
	...
	private static void mainJoystickButtons(Robot robot) {
		...
		// bindings...
		usedJoystick.Y.onTrue(new InstantCommand(() -> robot.getMultiAprilTagVisionSources().switchBotPose()));
		usedJoystick.X.onTrue(new InstantCommand(() -> robot.getPoseEstimator().changeDenoising(0)));
		usedJoystick.A.onTrue(new InstantCommand(() -> robot.getPoseEstimator().changeDenoising(1)));
		usedJoystick.B.onTrue(new InstantCommand(() -> robot.getPoseEstimator().changeDenoising(2)));
