...
public class PoseEstimatorConstants {
	...
	/**
	 * The vector represents how ambiguous each value is. The first value represents how ambiguous is the x, the second one for
	 * the y, and the third one is for the theta (rotation). Increase these numbers to trust the estimate less.
	 */
