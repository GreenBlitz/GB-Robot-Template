...
public class CANdleWrapper extends CANdle {
	...
	public ErrorCode animateColorFlowAnimation(Color color, int speed, int amountOfLedsToAffect, int startIndex){
		return this.animate(new ColorFlowAnimation((int) color.red, (int) color.green, (int) color.green, 0, speed, amountOfLedsToAffect, ColorFlowAnimation.Direction.Forward, startIndex));
	}

	public ErrorCode animateColorFlowAnimation(Color color, int speed, int amountOfLedsToAffect){
		return this.animate(new ColorFlowAnimation((int) color.red, (int) color.green, (int) color.green, 0, speed, amountOfLedsToAffect, ColorFlowAnimation.Direction.Forward));
	}
