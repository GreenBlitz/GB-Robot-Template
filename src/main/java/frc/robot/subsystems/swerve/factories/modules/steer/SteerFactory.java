...
public class SteerFactory {
	...
	public static ControllableMotor createSteer(String logPath, ModuleUtil.ModulePosition modulePosition) {
		...
		return switch (modulePosition) {
			case FRONT_LEFT ->
				KrakenX60SteerBuilder.buildSteer(logPath, IDs.TalonFXIDs.SWERVE_FRONT_LEFT_STEER, IDs.CANCoderIDs.SWERVE_FRONT_LEFT, false,modulePosition);
			case FRONT_RIGHT ->
				KrakenX60SteerBuilder.buildSteer(logPath, IDs.TalonFXIDs.SWERVE_FRONT_RIGHT_STEER, IDs.CANCoderIDs.SWERVE_FRONT_RIGHT, false,modulePosition);
			case BACK_LEFT ->
				KrakenX60SteerBuilder.buildSteer(logPath, IDs.TalonFXIDs.SWERVE_BACK_LEFT_STEER, IDs.CANCoderIDs.SWERVE_BACK_LEFT, false,modulePosition);
			case BACK_RIGHT ->
				KrakenX60SteerBuilder.buildSteer(logPath, IDs.TalonFXIDs.SWERVE_BACK_RIGHT_STEER, IDs.CANCoderIDs.SWERVE_BACK_RIGHT, false,modulePosition);
		};
	}
