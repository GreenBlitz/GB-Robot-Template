...
public enum AlgaeRemoveLevel {
	...
	LOW(ElevatorState.LOW_ALGAE_REMOVE, ArmState.LOW_ALGAE_REMOVE, EndEffectorState.ALGAE_INTAKE_FROM_REEF),
	HIGH(ElevatorState.HIGH_ALGAE_REMOVE, ArmState.HIGH_ALGAE_REMOVE, EndEffectorState.ALGAE_INTAKE_FROM_REEF);
