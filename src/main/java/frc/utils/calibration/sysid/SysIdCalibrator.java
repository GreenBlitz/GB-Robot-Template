...
public class SysIdCalibrator {
     ...
     *
     * @param voltageSetControl - note that this function needs to use kg in it so the mechanism won't move because of
     *     gravity.
     */
    ...
    /**
     * Sets for you all the buttons you need to do sysid calibration. The buttons are ordered by the click order.
     * IMPORTANT: You must do SignalLogger.stop() at the end of the calibration
     *
