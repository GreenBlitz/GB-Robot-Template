...
public class CameraCalibration extends Command {
    ...
    private Supplier<Transform3d> tagToCamera;
    ...
    public Pose3d getAvgPose() {
        ...
        return new Pose3d(sumX / pose.size(), sumY / pose.size(), sumZ / pose.size(), new Rotation3d(Math.atan2(sinXRotation, cosXRotation), Math.atan2(sinYRotation, cosYRotation), Math.atan2(sinZRotation, cosZRotation)
        ));
    }
