...
public class PoseEstimatorConstants {
	...
	public static final StandardDeviations2d DEFAULT_ODOMETRY_STANDARD_DEVIATIONS = new StandardDeviations2d(0.0003, 0.00003, Rotation2d.fromRadians(0.003));
	public static final StandardDeviations2d DEFAULT_VISION_STANDARD_DEVIATIONS = new StandardDeviations2d(0.0003, 0.00003, Rotation2d.fromRadians(0.003));
