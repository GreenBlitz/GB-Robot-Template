...
public class TalonFXSimulation {
    ...
    public TalonFXSimulation(
            TalonFXWrapper talonFXWrapper, TalonFXConfiguration configuration, MechanismSimulation simulation) {
    ...
    public void updateMotor() {
        ...
        motorSimState.setRotorVelocity(
                mechanismSimulation.getRotorVelocityAnglesPerSecond().getRotations());
    }
}
