...
public class ModuleUtil {
	...
	/**
	 * When the steer motor moves, the drive motor moves as well due to the coupling. This will affect the current positionRads of the drive
	 * motor, so we need to remove the coupling from the velocity or the positionRads.
	 */
