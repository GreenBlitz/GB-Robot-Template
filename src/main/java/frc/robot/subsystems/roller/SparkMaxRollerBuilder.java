...
public class SparkMaxRollerBuilder {
    ...
    public static Roller createSparkMaxMotorRoller (String logPath, int ID, double gearRatio, int currentLimiting, Rotation2d tolerance,double KP,double KI,double KD){
        ...
        SparkMaxRequest<Rotation2d> goToAngleRequest = SparkMaxRequestBuilder.build(Rotation2d.fromRotations(0), SparkBase.ControlType.kPosition,0);
