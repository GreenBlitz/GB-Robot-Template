...
public class IDs {
	...
	public static class TalonFXIDs {
        ...
        public static final Phoenix6DeviceID NOT_HOOD1 = new Phoenix6DeviceID(52, BusChain.ROBORIO);
        public static final Phoenix6DeviceID NOT_HOOD2 = new Phoenix6DeviceID(53, BusChain.ROBORIO);
