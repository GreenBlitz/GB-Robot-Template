...
public class Conversions {
    ...
    /**
     * Converts a target output voltage to a percentage output when voltage compensation is enabled. The voltage
     * compensation saturation determines what voltage represents 100% output. The compensated power is the voltage
     * represented by a percentage of the saturation voltage.
     *
    ...
    /**
     * Converts a target output percentage output to voltage when voltage compensation is enabled. The voltage
     * compensation saturation determines what voltage represents 100% output. The compensated power is the voltage
     * represented by a percentage of the saturation voltage.
     *
