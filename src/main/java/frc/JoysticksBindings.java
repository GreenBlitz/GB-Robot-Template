...
public class JoysticksBindings {
	...
	private static void mainJoystickButtons(Robot robot) {
		...
		// bindings...
		usedJoystick.A.onTrue(robot.getRobotCommander().setState(RobotState.ARM_PRE_L3));
		usedJoystick.B.onTrue(robot.getRobotCommander().setState(RobotState.L3_WITHOUT_RELEASE));
	}
