...
public enum ArmState {
	...
	PRE_L4(Rotation2d.fromDegrees(55), Rotation2d.fromRotations(2), Rotation2d.fromRotations(1.5)),
	L4(Rotation2d.fromDegrees(-25), Rotation2d.fromRotations(2), Rotation2d.fromRotations(1.5)),
	...
	ArmState(Rotation2d position, Rotation2d maxVelocityRotation2dPerSecond, Rotation2d maxAccelerationRotation2dPerSecondSquared) {
		this.position = position.plus(ArmConstants.POSITION_OFFSET);
