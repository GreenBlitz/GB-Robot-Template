...
public class Phoenix6SignalBuilder {
	...
	/**
	 * Use this function only if you are not fetching the slope signal. Ex: If you care only about positionThread and not velocityThread do:
	 * Phoenix6BothLatencySignal positionThread = Phoenix6SignalBuilder.generatePhoenix6Signal(motor.getPosition(), motor.getVelocity(),...);
	 */
