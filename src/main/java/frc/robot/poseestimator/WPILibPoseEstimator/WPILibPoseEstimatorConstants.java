...
public class WPILibPoseEstimatorConstants {
	...
	public static final StandardDeviations2D COLLISION_VISION_STD_DEV_REDUCTION = new StandardDeviations2D();
	...
	public static double ACCELERATION_BUFFER_SIZE_SECONDS = 2;
