...
public class VisionFilters {
	...
	protected static Filter<RawAprilTagVisionData> isAprilTagHeightInTolerance(double aprilTagMaxHeightToleranceMeters, double aprilTagMinimumHeightToleranceMeters) {
		return new Filter<>((RawAprilTagVisionData rawAprilTagVisionData) -> rawAprilTagVisionData.getAprilTagHeight() <= aprilTagMaxHeightToleranceMeters
